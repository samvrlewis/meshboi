...
ip netns exec blue ./meshboi client -server-ip 10.1.1.1 -tun-ip 192.168.50.1/24 &
ip netns exec green ./meshboi client -server-ip 10.1.1.1 -tun-ip 192.168.50.2/24 &
